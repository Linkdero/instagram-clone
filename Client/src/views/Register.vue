    ...
    main
      section.full.flex
        div.column.image
          ...
          p Red Social creada por: <strong>Linkdero</strong>
        div.column.flex.text
          div.content
            h1.text-center Registrate en <strong>Artgram</strong> Para explorar <strong>Nuevas Experiencias</strong>.
            ...
            p.text-center
              router-link(to="/login") Entrar con tu cuenta
          ul.social
